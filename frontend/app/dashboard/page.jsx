                    ...
                    {view === 'home' && (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                            ...
                            <button
                                ...
                                className="group relative overflow-hidden bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 hover:border-blue-500 rounded-2xl p-8 transition-all duration-300 text-left shadow-lg dark:shadow-none"
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Create Routine</h2>
                            ...
                            <button
                                ...
                                className="group relative overflow-hidden bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 hover:border-purple-500 rounded-2xl p-8 transition-all duration-300 text-left shadow-lg dark:shadow-none"
                            >
                                <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                                    <List size={120} />
                                </div>
                                <div className="relative z-10">
                                    ...
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Show Routines</h2>
                                    <p className="text-gray-500 dark:text-gray-400">
                            ...
                            <button
                                ...
                                className="group relative overflow-hidden bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 hover:border-emerald-500 rounded-2xl p-8 transition-all duration-300 text-left shadow-lg dark:shadow-none"
                            >
                                <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                                    <Users size={120} />
                                </div>
