...
function Mission() {
    return (
        <section className="py-20 px-4 bg-linear-to-br from-purple-100 via-white to-pink-100 dark:from-purple-900/20 dark:via-gray-950 dark:to-pink-900/20">
            <div className="max-w-7xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8">
                    <div
                        data-aos='flip-right'
                        className="bg-linear-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 p-8 rounded-3xl border border-purple-500/30">
                    ...
                    <div
                        data-aos='flip-left'
                        className="bg-linear-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 p-8 rounded-3xl border border-pink-500/30">
