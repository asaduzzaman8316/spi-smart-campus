        ...
        <section className="py-20 px-4 bg-gray-900/50">
            ...
            className="max-w-7xl mx-auto">
                ...
                <div data-aos='zoom-in'  className="grid md:grid-cols-3 gap-6">
                    <div className="bg-linear-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-purple-500 transition-all duration-300 hover:scale-105">
                    ...
                    <div data-aos='zoom-in' className="bg-linear-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-pink-500 transition-all duration-300 hover:scale-105">
                        <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <div data-aos='zoom-in' className="bg-linear-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-red-500 transition-all duration-300 hover:scale-105">
                        <div className="flex flex-col items-center text-center space-y-4">
