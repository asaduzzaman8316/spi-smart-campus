...
function Hero() {
    return (
        <section className="relative bg-linear-to-br from-purple-100 via-white to-pink-100 dark:from-purple-900/30 dark:via-gray-950 dark:to-pink-900/30 py-20 px-4 overflow-hidden">
